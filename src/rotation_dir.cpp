...
callback(std_msgs::Int64 num)
{
    ...
    if (pcd_index > 1){
        ...
        filename1 = "/home/wuxr/3Dscanner/cakin_ws2/src/Mini-3D-Scanner-master/data/" + std::to_string(pcd_index-1) + ".pcd";
        ...
        filename2 = "/home/wuxr/3Dscanner/cakin_ws2/src/Mini-3D-Scanner-master/data/" + std::to_string(pcd_index) + ".pcd";

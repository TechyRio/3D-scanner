...
callback(sensor_msgs::PointCloud2 cloud_raw)
{
    ...
    std::string filename = "/home/wuxr/3Dscanner/cakin_ws2/src/Mini-3D-Scanner-master/data/" + std::to_string(pcd_index) + ".pcd";
...
main (int argc, char **argv)
{
    ...
    ros::Publisher pub1 = nh.advertise<std_msgs::Int64> ("pcd_save_done", 1);
